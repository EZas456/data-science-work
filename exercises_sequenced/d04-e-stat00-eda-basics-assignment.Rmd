...
**Observations**:
- Ideal is the *most* common cut of diamond. Maybe because people who are in the diamond business are shooting to maximize profit and don't value labor highly relative to that.
...
**Observations**:
- All cuts look basically the same. There seems to be no correlation between price and cut.
...
**Observations**:
- Looks like the median ideal cut diamond sells for less than the median individual of any other cut. Could be that cutting the diamonds to "ideal" removes more material which makes them *smaller*.
...
**Observations**:
- There is s slight negative correlation between carat and the quality of the diamond cut. Interesting!

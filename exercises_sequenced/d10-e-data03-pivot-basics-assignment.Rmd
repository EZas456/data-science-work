...
__q4__ Recover `df_base` from `df_q3` by using a *single* pivot and no other functions.
...
__q5__ Recover `df_base` from `df_q3` by using a *single* pivot and no other functions.
...
__q6__ Using a single pivot on `df_base` create your own *challenge* dataframe. You will share this with the rest of the class as a puzzle, so make sure to solve your own challenge so you have a solution!

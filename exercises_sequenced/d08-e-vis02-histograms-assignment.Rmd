...
- Which graph---`vis1` or `vis2`---best helps you answer each question?
    vis1 helps a lot with the first one and could possibly answer the second. viz2 is much better at the second question.
...
**Observations**
- At binwidth of 0.01 we see pronounced spikes at 0.3, 0.4, 0.5, 0.7, 0.8, 0.9 and 1 carat.
- Those spikes still occur at 0.1 binwidth but very compressed. It is, however, easier to see the general downward trend in number of diamonds as carat increases.
- At 0.001 spikes are still pronounced but the general shape of the downward trends after each spike is visible.

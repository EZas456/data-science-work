...
**Observations**: Streptomycin (blue) and Neomycin (red) seem to be more
generally-effective antibiotics than Penicillin (green) for all but both
strains of Streptococcus and Diplococcus pneumonia. The four bacteria
that Penicillin is least effective on are also not affected very much by
the other two antibiotics either.
...
**Observations**: We can see that *most* bacteria of the same genus ahve
similar responses to antibiotics. The exceptions to that rule are
Diplococcus pneumonia which seems to behave similarly to a Streptococcus
(but we don’t know if Diplococcus in general are similar to
Streptococcus), and Streptococcus fecalis. For some reason this
particular one does not seem to have data for penicillin or
streptomycin. Additionally, the gram positive bacteria seem to be much
more reactive to penicillin while penicillin seems to be much less
effective on gram negative bacteria.
